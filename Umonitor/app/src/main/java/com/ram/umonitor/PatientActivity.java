...
import com.ram.umonitor.fragments.TrackHealth;

public class PatientActivity extends AppCompatActivity
        implements
        Home.OnFragmentInteractionListener,
        TrackHealth.OnFragmentInteractionListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setCheckedItem(R.id.nav_home_patient);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_track_health) {
            fragment=new TrackHealth();
        }
        //NOTE: Fragment changing code
        if (fragment != null) {
            FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
            ft.replace(R.id.mainFramePatient, fragment);
            ft.commit();
